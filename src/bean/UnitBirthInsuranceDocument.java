...
/**
 * UnitBirthInsuranceDocument entity. @author MyEclipse Persistence Tools
 */

public class UnitBirthInsuranceDocument extends UnitDocument implements java.io.Serializable {
	...
	/** default constructor */
	public UnitBirthInsuranceDocument() {
	}

	/** full constructor */
	public UnitBirthInsuranceDocument(Archive archive, String unitIdentifyId,
