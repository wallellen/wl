...
/**
 * UnitInjeryInsuranceDocument entity. @author MyEclipse Persistence Tools
 */

public class UnitInjeryInsuranceDocument extends UnitDocument implements java.io.Serializable {
	...
	/** default constructor */
	public UnitInjeryInsuranceDocument() {
	}

	/** full constructor */
	public UnitInjeryInsuranceDocument(Archive archive, String unitIdentifyId,
			String unitName, String documentName, String retentionPeriod,
			String physicsAdress, String time, String zone,
